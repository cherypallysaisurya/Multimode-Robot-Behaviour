...
def basic_movement_example():
    ...
    """
    # Create a robot program (uses default 8x8 grid)
    ...
    def moves():
        ...
        program.robot.move("right")  # Move right
        program.robot.move("right")  # Move right again
        program.robot.move("up")     # Move up
        program.robot.move("left")   # Move left
        program.robot.move("up")     # Move up
        program.robot.move("right")  # Move right
